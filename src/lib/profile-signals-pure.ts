...
/**
 * Pure helpers for psychological profile calculations.
 *
 * Extracted from `profile-signals.ts` so client-side callers can import
 * without dragging the server-only `db` module into the browser bundle.
 */
